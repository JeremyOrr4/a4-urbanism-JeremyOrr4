...
# git tag -a F3-A4 48fcf40 -m "For F3"
# git tag -a F9-A4 b049379 -m "For F9"
# git tag -a F8-A4 f4d5987 -m "For F8"
# git tag -a F10-A4 270b0e7 -m "For F10"
# git tag -a F4-A4 a76b6d1 -m "For F4"
# git tag -a F1-A4 f995630 -m "For F1"
# git tag -a F2-A4 0530dfb -m "For F2"
# git tag -a F5-A4 c83165f -m "For F5"
